...
$config['img_path'] = '/mitonios/upload'; // Relative to domain name
//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
$config['upload_path'] = 'D:/Google Driver/www' . $config['img_path']; // Physical path. [Usually works fine like this]
