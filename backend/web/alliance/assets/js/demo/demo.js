    ...
    var runDemoSourceCode = function () {
        ...
        if (bsElement.length) {
            ...
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: window.location.protocol + '//' + window.location.hostname + '/qlbh/backend/web/alliance/assets/js/plugins/highlight/styles/github.css'
            }).appendTo("head");

            $.getScript(window.location.protocol + '//' + window.location.hostname + '/qlbh/backend/web/alliance/assets/js/plugins/highlight/highlight.pack.js');
