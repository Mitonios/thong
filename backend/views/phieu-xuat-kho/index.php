...
<div class="page-bar">
    ...
    <div class="page-toolbar">
        <div class="pull-right">
            <a href="<?= Url::to(['create']) ?>" class="btn btn-primary btn-bordered ml10"><span class="fa fa-plus pr5"></span> Tạo phiếu xuất</a>
        </div>
    </div>
</div>
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?= $form->field($model, 'ma_phieu_xuat', ['template' => "{input}\n{error}"])->textInput(['placeholder' => $model->getAttributeLabel('ma_phieu_xuat')]); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <?= $form->field($model, 'ngay_xuat_from', ['template' => "{input}\n{error}"])->textInput([
                                'class' => 'form-control date-picker', 'placeholder' => $model->getAttributeLabel('ngay_xuat_from')]); ?>
                        </div>
                        <div class="col-md-6">
                            <?= $form->field($model, 'ngay_xuat_to', ['template' => "{input}\n{error}"])->textInput([
                                'class' => 'form-control date-picker', 'placeholder' => $model->getAttributeLabel('ngay_xuat_to')]); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        foreach ($models as $model) {
                            ...
                            <tr class="<?= $model->status == $model::STATUS_DRAFT ? "danger" : "" ?>">
                                <td><?= $model->ma_phieu_xuat ?></td>
                                <td><?= $model->ngay_xuat ?><br><i><?= $model->ghi_chu ?></i></td>
